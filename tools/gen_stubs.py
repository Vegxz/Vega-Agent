...
# ---------------------------------------------------------------- android.graphics
c('android.graphics.Color', [
    # MessagePanel's PopupWindow needs a (transparent) background drawable so
    # that touches outside the panel dismiss it.
...
c('android.graphics.Paint', [
    ...
    'public int getFontMetricsInt(android.graphics.Paint.FontMetricsInt fmi)',
    'public static class FontMetricsInt { public int top; public int ascent; public int descent; public int bottom; public int leading; }',
...
c('android.text.SpannableStringBuilder', [
    ...
    'public android.text.SpannableStringBuilder append(CharSequence text, int start, int end)',
...
c('android.text.style.MetricAffectingSpan', [
    'public abstract void updateDrawState(android.text.TextPaint tp)',
    'public abstract void updateMeasureState(android.text.TextPaint tp)',
], kind='abstract', extends='android.text.style.CharacterStyle')
c('android.text.style.ReplacementSpan', [
...
], kind='abstract', extends='android.text.style.MetricAffectingSpan')
c('android.text.style.RelativeSizeSpan', [
    'public RelativeSizeSpan(float proportion)',
    'public float getSizeChange()',
    'public void updateDrawState(android.text.TextPaint ds)',
    'public void updateMeasureState(android.text.TextPaint paint)',
], extends='android.text.style.MetricAffectingSpan')
c('android.text.style.SubscriptSpan', [
    'public SubscriptSpan()',
    'public void updateDrawState(android.text.TextPaint tp)',
    'public void updateMeasureState(android.text.TextPaint tp)',
], extends='android.text.style.MetricAffectingSpan')
c('android.text.style.SuperscriptSpan', [
    'public SuperscriptSpan()',
    'public void updateDrawState(android.text.TextPaint tp)',
    'public void updateMeasureState(android.text.TextPaint tp)',
], extends='android.text.style.MetricAffectingSpan')
c('android.text.style.TypefaceSpan', [
...
c('android.view.View', [
    ...
    'public <T extends android.view.View> T findViewWithTag(Object tag)',
    ...
    'public interface OnLongClickListener { boolean onLongClick(android.view.View v); }',
...
c('android.widget.PopupWindow', [
    # MessagePanel's long-press Select/Copy/Share popup.
...
c('android.webkit.RenderProcessGoneDetail', [
...
c('android.webkit.WebViewClient', [
    ...
    'public boolean onRenderProcessGone(android.webkit.WebView view,'
...
c('android.net.wifi.WifiManager', [
    ...
    'public android.net.wifi.WifiManager.WifiLock createWifiLock(int wifiMode, String tag)',
...
c('android.app.AlarmManager', [
    ...
    'public void setExactAndAllowWhileIdle(int type, long triggerAtMillis,'
