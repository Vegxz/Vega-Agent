...
object Icons {
    ...
    private val D: Map<String, String> = buildMap {
        ...
        put(
            "battery",
            "M2 8h14a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2H2z M20 10.5h1.5a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H20z M6 11v2M10 11v2"
        )
        ...
        // A phone handset with vibration waves on both sides — the Appearance
        // group's haptic-feedback switch. Feather has no vibration glyph, so
        // this one is drawn to the same 24x24 stroke idiom: a rounded handset
        // with two arcs radiating outward.
        put(
            "vibrate",
            "M9 3h6a1.5 1.5 0 0 1 1.5 1.5v15a1.5 1.5 0 0 1-1.5 1.5H9a1.5 1.5 0 0 1-1.5-1.5v-15A1.5 1.5 0 0 1 9 3z M4.6 8.6a4.4 4.4 0 0 0 0 6.8 M19.4 8.6a4.4 4.4 0 0 1 0 6.8"
        )
        ...
        // --- v9 additions -------------------------------------------------
        // Twin sparkles with smooth concave sides, in the register of SF Symbols'
        // "sparkles" — the mark Apple itself uses for on-device intelligence.
        // The old twin-star was drawn with straight edges and read as a clip-art
        // asterisk; these curves are what make it feel premium at a glance.
        // Each star is four cubics from tip to tip with both control points
        // tucked near the centre, which is what hollows the sides inward.
        put(
            "sparkle",
            "M10.5 2.5C11.6 8.4 11.6 8.4 17.5 9.5C11.6 10.6 11.6 10.6 10.5 16.5C9.4 10.6 9.4 10.6 3.5 9.5C9.4 8.4 9.4 8.4 10.5 2.5Z " +
                "M18 13.9C18.6 16.9 18.6 16.9 21.6 17.5C18.6 18.1 18.6 18.1 18 21.1C17.4 18.1 17.4 18.1 14.4 17.5C17.4 16.9 17.4 16.9 18 13.9Z"
        )
        // Magic wand — the skills mark. A wand plus two sparkles: it says
        // "craft" where the old four-point star said "generic AI shimmer", and
        // it no longer collides with the sparkle this app spends on assistant
        // mode and the task tool. Stroked like the rest of the set.
        put(
            "wand",
            "M5 19L13.5 10.5 " +
                "M16.8 3.2C17.2 5.3 18.3 6.4 20.4 6.8C18.3 7.2 17.2 8.3 16.8 10.4C16.4 8.3 15.3 7.2 13.2 6.8C15.3 6.4 16.4 5.3 16.8 3.2Z " +
                "M20 13.8C20.2 14.9 20.6 15.3 21.7 15.5C20.6 15.7 20.2 16.1 20 17.2C19.8 16.1 19.4 15.7 18.3 15.5C19.4 15.3 19.8 14.9 20 13.8Z " +
                "M8.5 15.5h.01"
        )
        ...
        // Horizontal sliders — the "User Interface" destination mark, in the
        // register of SF Symbols' "slider.horizontal.3". Three rails with a
        // ringed knob on each, staggered left / right / left so the row reads
        // as adjustable at a glance. Each knob is two half-arcs; the rail
        // stops at the knob's edge on both sides.
        put(
            "sliders-h",
            "M2.5 6h4.3M11.2 6h10.3 M6.8 6a2.2 2.2 0 1 0 4.4 0a2.2 2.2 0 1 0-4.4 0 " +
                "M2.5 12h10.3M17.2 12h4.3 M12.8 12a2.2 2.2 0 1 0 4.4 0a2.2 2.2 0 1 0-4.4 0 " +
                "M2.5 18h2.3M9.2 18h12.3 M4.8 18a2.2 2.2 0 1 0 4.4 0a2.2 2.2 0 1 0-4.4 0"
        )
        ...
        // Share: three nodes joined by two links (Feather's share-2 geometry).
        // Stroked like every other outline glyph in the set — the circles are
        // drawn with arc pairs so the stroke width stays uniform.
        put(
            "share",
            "M21 5a3 3 0 1 1-6 0a3 3 0 1 1 6 0 " +
                "M9 12a3 3 0 1 1-6 0a3 3 0 1 1 6 0 " +
                "M21 19a3 3 0 1 1-6 0a3 3 0 1 1 6 0 " +
                "M8.59 13.51l6.83 3.98 M15.41 6.51l-6.82 3.98"
        )
        // Select: an I-beam text cursor — the shape of "start selecting text".
        put(
            "select",
            "M12 5v14 M9 8l3-3 3 3 M9 16l3 3 3-3"
        )
    }
