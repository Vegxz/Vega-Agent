...
class Sheet(private val c: Context) {
    ...
    companion object {
        ...
        /**
         * True while at least one sheet is on screen.
         *
         * MainActivity's keyboard watcher uses this: a sheet opening hides the
         * keyboard on the same frame it takes window focus (the @-mention file
         * browser is the everyday case), and that dismissal is incidental — not
         * the user saying "I'm done typing" — so the composer's focus must be
         * left alone.
         */
        fun isAnyOpen(): Boolean = OPEN.isNotEmpty()
    }
}
