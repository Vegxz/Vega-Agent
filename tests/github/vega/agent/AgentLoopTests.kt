 ...
 * Everything inside `github.vega.agent` is the shipping code.
 */
object AgentLoopTests {
    ...
    private class Ctx(server: HttpServer?, key: String = "sk-test-key", base: String? = null) :
        ...
        init {
            ...
            // No protocol setting any more: detection is automatic per endpoint,
            // so a stale stored provider must not influence the request.
        ...
        override fun getPackageName(): String = "github.vega.agent"
    }
